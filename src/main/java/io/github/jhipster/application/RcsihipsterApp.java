...
public class RcsihipsterApp {

    private static final Logger log = LoggerFactory.getLogger(RcsihipsterApp.class);

    private final Environment env;

    public RcsihipsterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes rcsihipster.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RcsihipsterApp.class);
